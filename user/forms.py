...
class RegForm(forms.Form):
	username = forms.CharField(label='用户名',max_length=10,min_length=1,
		                        widget=forms.TextInput(attrs={'class':'form-control','placeholder':'请输入1~10位的用户名'}))
...
class ChangeNicknamaFrom(forms.Form):
	...
	def __init__(self,*args,**kwargs):
		...
		super(ChangeNicknamaFrom,self).__init__(*args,**kwargs)
